...
describe('settings queries', () => {
    ...
    it('set upserts the key/value pair', () => {
        ...
        expect(mockDb.execute).toHaveBeenCalledWith(
            ...
            ['company_name', 'AL-SHEIKH', 'AL-SHEIKH']
        );
    });
});
...
describe('dashboard queries', () => {
    ...
    it('getItemsStock joins categories table', () => {
        ...
        expect(mockDb.query).toHaveBeenCalledWith(
            expect.stringContaining('LEFT JOIN categories c')
        );
    });
    ...
    it('getSupplierAdvances filters for advance_amount > 0', () => {
        ...
        expect(mockDb.query).toHaveBeenCalledWith(
            expect.stringContaining('advance_amount > 0')
        );
    });
});
...
describe('sales queries', () => {
    ...
    it('create inserts sale header and line items', () => {
        ...
        mockDb.query
            .mockReturnValueOnce([{ prefix: 'SL-', current_number: 0, number_length: 6 }]); // getNextSaleNumber
        mockDb.execute.mockReturnValue({ lastInsertRowid: 1 });
        ...
        const saleData = {
            ...
            items: [
                { item_id: 1, customer_id: 1, weight: 90, rate: 200, fare_charges: 0, ice_charges: 0, cash_amount: 0, receipt_amount: 0 },
            ],
        };
    ...
    it('create calculates correct net amount for sale header', () => {
        mockDb.query
            .mockReturnValueOnce([{ prefix: 'SL-', current_number: 0, number_length: 6 }]);
        mockDb.execute.mockReturnValue({ lastInsertRowid: 1 });
        ...
        const saleData = {
            ...
            items: [
                {
                    item_id: 1, customer_id: 1,
                    weight: 90, rate: 200,
                    fare_charges: 100, ice_charges: 50,
                    cash_amount: 0, receipt_amount: 0,
                },
            ],
        };
