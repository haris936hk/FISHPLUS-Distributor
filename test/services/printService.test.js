...
describe('Print Service', () => {
    ...
    beforeEach(() => {
        ...
        BrowserWindow.mockImplementation(function () { return mockWindow; });
    });
    ...
    describe('exportToExcel', () => {
        it('creates and saves workbook', async () => {
            ...
            const mockWorksheet = {
                ...
                getRow: vi.fn().mockReturnValue({ values: [], font: {}, fill: {}, border: {}, getCell: vi.fn().mockReturnValue({}) }),
                addRows: vi.fn(),
            };
            ...
            ExcelJS.Workbook.mockImplementation(function () { return mockWorkbook; });
    ...
    describe('printPreview', () => {
        it.skip('creates a window and loads content with controls', async () => {
            ...
            expect(mockPreviewWindow.loadURL).toHaveBeenCalledWith(expect.stringContaining('Print Preview'));
